...
Also added a dependence for confd which fetches key from paricular postion .
...
- [puneets-confd-cookbook](https://github.com/puneetdce/puneets-confd-cookbook)
...
- Update to create a key foo which fecthes cert from s3 location . 
